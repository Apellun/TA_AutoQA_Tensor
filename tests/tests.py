...
from utils.const import (TENSOR_ABOUT_PAGE_URL, MOSKVA_CONTACTS_TITLE,
                         KAMCHATSKIY_KRAI_CONTACTS_TITLE,
                         KAMCHATSKIY_KRAI_CONTACTS_URL_PART,
...
class Test:   
    def test_first_scenario(self, py):
        ...
        page.go_to_tensor_about_power_in_people_block_link()
        assert TENSOR_ABOUT_PAGE_URL == page.get_current_url()
    ...
    def test_second_scenario(self, py):
        ...
        assert page.contacts_check_region(MOSKVA_CONTACTS_TITLE) # YAROSLAVSKAYA_OBL_REGION_TITLE
        # page.contacts_check_region_title(YAROSLAVSKAYA_OBL_CONTACTS_TITLE)
        ...
        assert page.current_url_contains(KAMCHATSKIY_KRAI_CONTACTS_URL_PART)
        assert page.contacts_check_region_title(KAMCHATSKIY_KRAI_CONTACTS_TITLE)